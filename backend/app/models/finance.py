...
class InvoiceApplication(Base):
    ...
    buyer_address: Mapped[str | None] = mapped_column(String(500), nullable=True, comment="购方地址电话")
    buyer_bank: Mapped[str | None] = mapped_column(String(500), nullable=True, comment="购方开户行及账号")
    ...
    # 申请状态
    status: Mapped[str] = mapped_column(String(20), default="pending", nullable=False, comment="状态: pending/approved/rejected")
    
    # 申请人
    applicant_id: Mapped[int] = mapped_column(BigInteger, ForeignKey("users.id"), nullable=False, comment="申请人ID")
    
    # 审批信息
    approver_id: Mapped[int | None] = mapped_column(BigInteger, ForeignKey("users.id"), nullable=True, comment="审批人ID")
    approve_time: Mapped[datetime | None] = mapped_column(DateTime, nullable=True, comment="审批时间")
...
class Invoice(Base):
    ...
    # 发票号码
    invoice_no: Mapped[str] = mapped_column(String(50), unique=True, nullable=False, comment="发票号码")
    invoice_code: Mapped[str | None] = mapped_column(String(50), nullable=True, comment="发票代码")
    
    # 关联
    contract_id: Mapped[int] = mapped_column(BigInteger, ForeignKey("contracts.id"), nullable=False, comment="合同ID")
    application_id: Mapped[int | None] = mapped_column(BigInteger, ForeignKey("invoice_applications.id"), nullable=True, comment="申请ID")
    ...
    tax_amount: Mapped[Decimal | None] = mapped_column(Numeric(18, 2), nullable=True, comment="税额")
    ...
    # 状态
    status: Mapped[str] = mapped_column(String(20), default=InvoiceStatus.PENDING, nullable=False, comment="状态")
    
    # 寄送信息
    send_date: Mapped[date | None] = mapped_column(Date, nullable=True, comment="寄送日期")
    express_company: Mapped[str | None] = mapped_column(String(50), nullable=True, comment="快递公司")
    express_no: Mapped[str | None] = mapped_column(String(50), nullable=True, comment="快递单号")
    
    # 开票人
    issuer_id: Mapped[int | None] = mapped_column(BigInteger, ForeignKey("users.id"), nullable=True, comment="开票人ID")
    
    # 备注
    remark: Mapped[str | None] = mapped_column(Text, nullable=True, comment="备注")
    
    # 关联关系
    contract: Mapped["Contract"] = relationship("Contract", back_populates="invoices", lazy="selectin")
...
class InvoiceItem(Base):
    ...
    invoice_id: Mapped[int] = mapped_column(BigInteger, ForeignKey("invoices.id", ondelete="CASCADE"), nullable=False, comment="发票ID")
    
    # 明细信息
    name: Mapped[str] = mapped_column(String(200), nullable=False, comment="项目名称")
    specification: Mapped[str | None] = mapped_column(String(200), nullable=True, comment="规格型号")
...
class PaymentPlan(Base):
    ...
    plan_amount: Mapped[Decimal] = mapped_column(Numeric(18, 2), nullable=False, comment="计划回款金额")
    ...
    # 状态
    status: Mapped[str] = mapped_column(String(20), default=PaymentStatus.PENDING, nullable=False, comment="状态")
...
class Payment(Base):
    ...
    # 关联
    contract_id: Mapped[int] = mapped_column(BigInteger, ForeignKey("contracts.id"), nullable=False, comment="合同ID")
    plan_id: Mapped[int | None] = mapped_column(BigInteger, ForeignKey("payment_plans.id"), nullable=True, comment="回款计划ID")
    invoice_id: Mapped[int | None] = mapped_column(BigInteger, ForeignKey("invoices.id"), nullable=True, comment="关联发票ID")
    ...
    payer_account: Mapped[str | None] = mapped_column(String(100), nullable=True, comment="付款账号")
    payer_bank: Mapped[str | None] = mapped_column(String(200), nullable=True, comment="付款银行")
    
    # 我方账户
    receiver_account: Mapped[str | None] = mapped_column(String(100), nullable=True, comment="收款账号")
    receiver_bank: Mapped[str | None] = mapped_column(String(200), nullable=True, comment="收款银行")
    
    # 凭证
    voucher_no: Mapped[str | None] = mapped_column(String(100), nullable=True, comment="凭证号")
    
    # 登记人
    recorder_id: Mapped[int | None] = mapped_column(BigInteger, ForeignKey("users.id"), nullable=True, comment="登记人ID")
    
    # 备注
    remark: Mapped[str | None] = mapped_column(Text, nullable=True, comment="备注")
    
    # 关联关系
    contract: Mapped["Contract"] = relationship("Contract", back_populates="payments", lazy="selectin")
